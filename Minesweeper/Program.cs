...
namespace Minesweeper
{
    class Program
    {
        ...
        public static bool _gameOver, victory, firstClick, calcFontSize, firstRun = true, userChangedSettings = false;

        public static int nBomb, columns, rows, firstClickX, firstClickY, openBoxes, rFlag, boxW, boxH, topPanelH = 80, gameAreaH;
        ...
        static Label rFlagLabel, gameOverLabel;
        ...
        public static void initGame()
        {
            ...
            gameAreaH = gameForm.ClientSize.Height - topPanelH;
            ...
            flagIcon.Left = gameForm.ClientSize.Width - flagIcon.Width - 60;
            flagIcon.Top = 0;
            flagIcon.Image = Resource1.flag;
            gameForm.Controls.Add(flagIcon);

            rFlagLabel.Size = new Size(80, 80);
            rFlagLabel.Left = flagIcon.Right;
            rFlagLabel.Top = 0;
            rFlagLabel.Text = rFlag.ToString();
            ...
            if (calcFontSize)
            {
                ...
                {
                    fontSizeRFlag = ((Math.Min(rFlagLabel.Width, rFlagLabel.Height) * (72f / g.DpiY)) - 1) / 2;
                    fontSizeRFlag = Math.Max(16f, fontSizeRFlag);
                }
            }
            rFlagLabel.Font = new Font(new FontFamily(GenericFontFamilies.Serif), fontSizeRFlag, FontStyle.Bold);
            gameForm.Controls.Add(rFlagLabel);

            gameOverLabel.Text = "You Lose";
            gameOverLabel.Left = 10;
            gameOverLabel.Font = new Font(new FontFamily(GenericFontFamilies.Serif), 16, FontStyle.Bold);
            gameOverLabel.AutoSize = true;
            gameOverLabel.Top = topPanelH / 2 - gameOverLabel.Height / 2;
            gameForm.Controls.Add(gameOverLabel);
            gameOverLabel.Hide();

            settingsButton.Size = new Size(80, 80);
            settingsButton.Left = gameOverLabel.Right + 10;
        ...
        static void Main()
        {
            ...
            rFlagLabel = new Label(); gameOverLabel = new Label();
    ...
    public partial class SettingsMenu : Form
    {
        ...
        public SettingsMenu()
        {
            ...
            columnsSelect = makeNumericUpDown(Program.columns, 1, 5, 25, columnsLabel.Font.Size, nBombSelect.Width, nBombSelect.Left, columnsLabel.Top);
            columnsSelect.KeyPress += numericUpDown_KeyPress;

            Label rowsLabel = makeLabel("Rows:", 16, 0, columnsSelect.Bottom + 10, false, null);
            rowsSelect = makeNumericUpDown(Program.rows, 1, 5, 25, rowsLabel.Font.Size, columnsSelect.Width, columnsSelect.Left, rowsLabel.Top);
